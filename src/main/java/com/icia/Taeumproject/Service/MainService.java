...
public class MainService {
  ...
  public void insertServ(int m_id,String fromAddress,Point startPoint,int sOrE,RedirectAttributes rttr, LocalDateTime A_DATE, Timestamp A_LOCALDATE) {
      log.info("insertServ()");
      Node node = new Node();
      ...
      node.setA_LOCALDATE(A_LOCALDATE);
